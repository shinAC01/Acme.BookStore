...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c5342c29-4ec9-4bfb-acfe-c8e9e0607fa6
```

> `c5342c29-4ec9-4bfb-acfe-c8e9e0607fa6` is the password of the certificate, you can change it to any password you want.
